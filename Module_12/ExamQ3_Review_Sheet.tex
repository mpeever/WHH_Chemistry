...
\question[5] What is the correct chemical equation to show \ce{H2SO4} producing \ce{H3O^{+}} ions in water?

\begin{solution}
\ce{H2SO4 (aq) + 2H2O (l) -> 2H3O^{+} (aq) + SO4^{2-} (aq)}
\end{solution}

\question[5] What is the correct chemical equation to show \ce{NaOH} producing \ce{OH^{-}} ions in water?

\begin{solution}
\ce{NaOH (aq) + \xcancel{H2O (l)} -> Na^{+} (aq) + OH^{-} (aq) + \xcancel{H2O (l)}}
\end{solution}

\clearpage
\question[5] What is the correct chemical equation to show \ce{NH3} producing \ce{OH^{-}} ions in water?
...
%        &= (0.100 L) (2.34 \frac{mol}{L}) (35.461 \frac{g}{mol}) \\
        &= (0.100 \xcancel{L}) (2.34 \frac{\xcancel{mol}}{\xcancel{L}}) (35.461 \frac{g}{\xcancel{mol}}) \\
        &= 8.297874 g \\
        &= 8.30 g
 \end{split}
 \end{equation}
