...
\item in other words\ldots if we mix two gases with two different pressures, the mixture's pressure will be the sum of their pressurs
\end{itemize}
...
The pressure exerted by the vapor which sites on top of any liquid.
\end{definition}
