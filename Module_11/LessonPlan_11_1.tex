...
\begin{itemize}
\item explain what a \textbf{solution} is
\item describe a solution in correct terms: ``solute," ``solvent"
...
\item just like with ionics, polar covalent compounds ``disappear" into the water\footnote{The kids are to young to remember INXS, but it goes \emph{so well} here.} 
\end{itemize}
...
\item \emph{e.g.} salmon have trouble spawning in streams when the temperature is too hot (not enough \ce{O2} in solution)
