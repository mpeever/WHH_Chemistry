...
\question[5] Jack has a tank of methane gas (\ce{CH4}). He wants to measure out $0.500$ ($5.00 \times 10^{-1}$) moles of methane by mass, so he needs to know the molar mass.\\
...
\question[5] Ella wants to burn her methane gas. Avery reminds her that the chemical reaction for incomplete combustion of methane requires methane and oxygen and produces carbon monoxide and water. 
...
\question[5] Gideon asks Caroline to calculate the number of grams of water vapor produced when Ella and Nate blew up the balloon. How many \emph{grams} of \ce{H2O} were produced?\\
