...
\begin{enumerate}
\item \ce{NaOH + HCl ->  H2O + NaCl } 

\item \ce{CH4 (g) + 2O2 (g)  -> CO2 (g) + 2H2O (g)}	

\item \ce{2LiOH + H2SO4 -> Li2SO4 + 2H2O}

\item \ce{C3H8 (g) + 5O2 (g) -> 3CO2 (g) + 4H2O (g)}
\end{enumerate}
\end{solution}
\vspace{.2in}
...
\question[1] 
How many protons are in the nucleus of an Oxygen (\ce{O}) atom?
\vspace{.2in}
