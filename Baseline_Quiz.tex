...
\begin{parts}
\part[1] $\frac{3 \pi}{4} \times \frac{1}{2 \pi}$

\part[1] $\frac{256 \pi}{32} \times 12$

\part[1] $\frac{x^2-1}{x + 1} \times \frac{2}{x - 1}$

%\part[1] $\frac{2x^2+4x+2}{x^2-1} \times \frac{3x}{6}$
...
%\bonusquestion[3] (Bonus) Three men are called ``king of kings" in Scripture, who are they?
