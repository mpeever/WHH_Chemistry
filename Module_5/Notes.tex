...
\item \textbf{Complete Combustion Reactions} combine compounds containing \ce{C} and \ce{H} with \ce{O2} to produce \ce{CO2} and \ce{H2O}
\item \textbf{Incomplete Combustion Reactions} are combustion reactions that produce \ce{CO} instead of \ce{CO2}
...
\item so for \ce{H2}, there are two \ce{H} atoms\ldots the mass must be:\\
$$ 2 \times 1.00794 amu = 2.01588 amu$$
\item for \ce{O2}, there are two \ce{O} atoms\ldots the mass must be:\\
 $$ 2 \times 15.9994 amu = 31.9988 amu $$
\item for \ce{H2O}, there are two  \ce{H} atoms and one \ce{O} atom\ldots the mass must be: \\
...
\item an element's mass in \emph{amu} is the same as a mole of that element's mass in grams\footnote{This is why there aren't mass units in the Periodic Table: a single \ce{H} atom has a mass of $1.00794 amu$, a mole of \ce{H} atoms has a mass of $1.00794 g$.}
...
\item or, we could say it takes two dozen \ce{H2} molecules and one dozen \ce{O2} molecules to make two dozen \ce{H2O} molecules
\item or, we could say it takes two gross of \ce{H2} molecules and one gross of \ce{O2} molecules to make two gross of \ce{H2O} molecules
\item or, we could say it takes two moles of \ce{H2} molecules and one mole of \ce{O2} molecules to make two mole of \ce{H2O} molecules
\end{itemize}
