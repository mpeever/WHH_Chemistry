...
\title{Module 6: Stoichiometry (Reprise)}
...
\emph{on y va!}\footnote{``Let's get going!"}
...
\footnote{I bet you were wondering where 19 would show up, weren't you? I'll be honest: I was happy to see it show up.} 
\begin{equation} 
\boxed{
\begin{split}
       \alpha   &                 & +1 \gamma & -1 \epsilon  &= 0 \\
...
\begin{itemize}
\item the idea here is that we can figure out on variable in terms of one other, then we can eliminate variables
...
\end{split}
 ...
 \section{Conclusion}
 We can balance chemical equations by keeping tabs on the atoms on each side. This way works, and it's probably the fastest approach for most of the chemical equations we'll see in this class.
 ...
 \footnote{I found a short paper published in \emph{Applied Mathematics} explaining this approach\cite{hamid:balancing:linear}. I was delighted to see the author used a similar combustion reaction to ours as an example: perhaps great minds do occasionally think alike?} 
...
\footnote{This example also demonstrates that I was willing to burn a whole lot of time on my weekend to come up with this doc. Perhaps I have too much time on my hands.}
