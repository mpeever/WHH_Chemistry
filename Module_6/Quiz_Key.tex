...
\begin{split}
    ...
    m &= n \times M \\
    n &= \frac{m}{M} \\
       &= \frac{500.0 \xcancel{g}}{44.09562  \frac{\xcancel{g}}{mol}} \\
       &= 11.3389946666 mol \\
       &= 11.34 mol
 \end{split}
 \end{equation}
...
\begin{solution}
Thomas generally is right. An outdoor combustion has virtually limitless \ce{O2} to consume, so \ce{C3H8} is the limiting reactant.
\end{solution}
