...
\item but it actually looks more like Figure 9.1 in your text \cite[p. 290]{wile-chem-2}
...
%\begin{figure}[hp]
%\centering
%\includegraphics[scale=0.25]{methane.png}
...
Answers to Practice Problems p. 318 \# 1--10:
\begin{enumerate}
\item 
\begin{enumerate}
\item \ce{K2SO4}
