...
\item \emph{e.g.} table salt is made up of one Sodium atom and one Chlorine atom, so we write it as \ce{NaCl}
\item \emph{e.g.} sulfuric acid is written as \ce{H2SO4}, so each molecule contains two Hydrogen atoms, one Sulfur atom, and four Oxygen atoms
\end{itemize}
