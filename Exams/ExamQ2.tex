...
\question[2] Am\'elie knows that methane (\ce{CH4}) is a \emph{covalent compound}, because it's made up of two non-metals.
She doesn't like the name ``methane," though. (She doesn't even like to say ``water," preferring to call it ``dihydrogen monoxide.")\\
What is another name could Am\'elie call \ce{CH4}?\\
...
\question[5] Jack has a tank of methane gas (\ce{CH4}). He wants to measure out $0.500$ moles of methane by mass, so he needs to know the molar mass.\\
...
\question[5] Jack fills a balloon with $0.500$ moles ($5.00 \times 10^{-1}$ moles) of methane gas (\ce{CH4})  and gives the balloon to Ella. How many \emph{grams} of methane gas does Ella have in her balloon?
...
\question[5] Ella wants to burn her methane gas. Avery reminds her that the chemical reaction for incomplete combustion of methane consumes methane and oxygen, producing carbon monoxide and water. 
Avery wouldn't ever do something so gauche as using an unbalanced chemical equation, so she balances it when she writes it down. \\
What does the balanced chemical equation for incomplete combustion of methane (\ce{CH4}) look like?\\
...
\footnote{Nate gets way more use out of his cattle prod than he had anticipated when he bought it. He's starting to think it was a good investment.}
...
How many \emph{moles} of \ce{O2} were consumed?
...
\begin{split}
    M_{\ce{O2}} &= 2 (15.9994 \frac{g}{mol}) \\
                        &= 31.9988 \frac{g}{mol} \\                        
    m &= n \times M \\
        &= (1.00 mol ) (31.9988 \frac{g}{mol}) \\
        &= (1.00 \xcancel{mol} ) (31.9988 \frac{g}{\xcancel{mol}}) \\
        &= 31.9988 g \\
        &= 32.0 g
 \end{split}
 \end{equation}
...
\question[5] Caroline is curious how much water vapor is produced in the \emph{BOOM!} reaction. How many \emph{moles} of water vapor (\ce{H2O}) were produced?
\begin{solution}
There are $2$ moles of \ce{H2O} produced for every mole of \ce{CH4} in our reaction: \ce{CH4 + 2O2 -> CO2 + 2H2O}\\

\begin{equation} 
\begin{split}
    \frac{n_{\ce{H2O}}}{2} &= \frac{n_{\ce{CH4}}}{1} \\
    n_{\ce{H2O}} &= 2 n_{\ce{CH4}} \\
                       &= 2 (0.500 mol ) \\
                       &= 1.00 mol \\
                       &= 1.00 mol
 \end{split}
...
\question[5] Gideon wants to know the mass of water vapor produced in the combustion. How many \emph{grams} of water vapor (\ce{H2O}) were produced?\\
...
\begin{split}
    M_{\ce{H2O}} &= 2 (1.00794 \frac{g}{mol}) + (15.9994 \frac{g}{mol}) \\
                           ...
                           &= 18.0153 \frac{g}{mol} \\              
    m &= n \times M \\
        &= (1.00 mol ) (18.0153 \frac{g}{mol}) \\
        &= (1.00 \xcancel{mol} ) (18.0153 \frac{g}{\xcancel{mol}}) \\
        &= 18.0153 g \\
        &= 18.0 g
 \end{split}
 \end{equation}
...
\begin{solution}
Thomas is right. An outdoor combustion has virtually limitless \ce{O2} to consume, so \ce{CH4} is the limiting reactant.
\end{solution}



\bonusquestion \emph{Bonus Question} 
The book of Genesis closes with, ``he was put in a coffin in Egypt" (Genesis 50:26, ESV).
